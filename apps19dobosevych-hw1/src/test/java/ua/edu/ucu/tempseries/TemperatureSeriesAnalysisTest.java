...
public class TemperatureSeriesAnalysisTest {
    ...
    public void testSummaryStatistic() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, 5.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
        TempSummaryStatistics tSS = new TempSummaryStatistics(1.0, 3.7416573867739413, -5.0, 5.0);
        double[] expResult = {tSS.getAvgTemp(), tSS.getDevTemp(), tSS.getMinTemp(), tSS.getMaxTemp()};

        TempSummaryStatistics tSS2 = seriesAnalysis.summaryStatistics();
        double[] actualResult = {tSS2.getAvgTemp(), tSS2.getDevTemp(), tSS2.getMinTemp(), tSS2.getMaxTemp()};

        assertEquals(Arrays.toString(expResult), Arrays.toString(actualResult));
    }

    @Test(expected = IllegalArgumentException.class)
    public void testSummaryStatisticWithEmptyArray() {
        double[] temperatureSeries = {};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
    ...
    public void testAddTemps() {
        ...
        double[] addIns = {0.0, 7.5, 8.8, 9.3, -14.9};
        int actualResult = seriesAnalysis.addTemps(addIns);
    ...
    public void testAddTempsWithEmptyArray() {
        ...
        double[] addIns = {0.0, 7.5, 8.8, 9.3, -1444.9};
        int actualResult = seriesAnalysis.addTemps(addIns);
    }

    @Test(expected = InputMismatchException.class)
    public void testConstructor() {
        double[] temperatureSeries = {3.0, -5.0, 1.0, -500.0};
        TemperatureSeriesAnalysis seriesAnalysis = new TemperatureSeriesAnalysis(temperatureSeries);
    }
}
